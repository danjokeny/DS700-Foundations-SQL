...
/*4.	Write and execute a SQL query to list all the patient data for all encounters. 
If the patient data is missing in other tables like Visit summary, then DO NOT include 
this encounter in your output. Your output should list all the columns (without repeating them) 
starting with encounter_id, patient_nbr… and it should be ordered by patient_nbr and 
then encounter_id. [10PTS]*/
